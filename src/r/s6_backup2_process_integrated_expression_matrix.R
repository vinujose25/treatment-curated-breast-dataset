# s6_backup2_process_integrated_expression_matrix
...
mdlist$log2_combat_m <- update_clin(clin, x, module_list, pam50)
...
# names(mdlist)
# "log2", "log2_combat",
# "log2_mscale", "log2_mscale_combat", "log2_mscale_dgc","log2_mscale_ggc",
...
# 2               log2_combat 0.8662330 0.6790740 0.8808437 0.7293906
# 3               log2_qscale 0.8905125 0.7329950 0.8697318 0.7888883
# 4        log2_qscale_center 0.8899781 0.8208107 0.8815289 0.7929771
# 5      log2_qscale_combat_m 0.8854926 0.7533206 0.8939960 0.7788766
# 6        log2_qscale_combat 0.8663224 0.6763927 0.8799683 0.7304517
# 7           log2_qscale_dgc 0.8714213 0.6293133 0.8929438 0.7795209
# 8    log2_qscale_center_dgc 0.8715006 0.6317567 0.8920319 0.7713475
# 9  log2_qscale_combat_m_dgc 0.8714213 0.6293133 0.8929438 0.7795209
# 10   log2_qscale_combat_dgc 0.8714213 0.6293133 0.8929438 0.7795209
# 11          log2_qscale_ggc 0.8881102 0.7255954 0.8697318 0.7888883
# 12   log2_qscale_center_ggc 0.8891710 0.8073648 0.8815289 0.7929771
# 13 log2_qscale_combat_m_ggc 0.8831609 0.7351955 0.8939960 0.7788766
# 14   log2_qscale_combat_ggc 0.8627425 0.6659506 0.8799683 0.7304517
# 15              log2_mscale 0.8903623 0.8198280 0.8831052 0.7985646
# 16     log2_mscale_combat_m 0.8883379 0.7419804 0.8999574 0.7721888
# 17       log2_mscale_combat 0.8661586 0.6766992 0.8808088 0.7273718
# 18          log2_mscale_dgc 0.8718632 0.6278639 0.8926274 0.7685060
# 19 log2_mscale_combat_m_dgc 0.8718632 0.6278639 0.8926274 0.7685060
# 20   log2_mscale_combat_dgc 0.8718632 0.6278639 0.8926274 0.7685060
# 21          log2_mscale_ggc 0.8893227 0.8048504 0.8831052 0.7985646
# 22 log2_mscale_combat_m_ggc 0.8854840 0.7259791 0.8999574 0.7721888
# 23   log2_mscale_combat_ggc 0.8625100 0.6662378 0.8808088 0.7273718
...
#                 type    er_sig  her2_sig   er_gene her2_gene
# 1               log2 0.8266707 0.5158213 0.7912057 0.6059456
# 2        log2_combat 0.8662330 0.6790740 0.8808437 0.7293906 !rle ok
# 3        log2_mscale 0.8903623 0.8198280 0.8831052 0.7985646
# 4 log2_mscale_combat 0.8661586 0.6766992 0.8808088 0.7273718 !rle ok
# 5    log2_mscale_dgc 0.8718632 0.6278639 0.8926274 0.7685060 !rle ok; auc ER best, HER2 gene best
# 6    log2_mscale_ggc 0.8893227 0.8048504 0.8831052 0.7985646
...
# 3               log2_qscale 0.6374579
# 4        log2_qscale_center 0.6334753
# 5      log2_qscale_combat_m 0.6314463
# 6        log2_qscale_combat 0.6163832
# 7           log2_qscale_dgc 0.6318883
# 8    log2_qscale_center_dgc 0.6298280
# 9  log2_qscale_combat_m_dgc 0.6318883
# 10   log2_qscale_combat_dgc 0.6318883
# 11          log2_qscale_ggc 0.6327868
# 12   log2_qscale_center_ggc 0.6244680
# 13 log2_qscale_combat_m_ggc 0.6324826
# 14   log2_qscale_combat_ggc 0.6101399
# 15              log2_mscale 0.6332773
# 16     log2_mscale_combat_m 0.6275684
# 17       log2_mscale_combat 0.6159144
# 18          log2_mscale_dgc 0.6206495
# 19 log2_mscale_combat_m_dgc 0.6206495
# 20   log2_mscale_combat_dgc 0.6206495
# 21          log2_mscale_ggc 0.6218727
# 22 log2_mscale_combat_m_ggc 0.6270759
# 23   log2_mscale_combat_ggc 0.6114997
...
#                 type     kappa
# 1               log2 0.6208237
# 2        log2_combat 0.6173302 !rle ok
# 3        log2_mscale 0.6332773
# 4 log2_mscale_combat 0.6159144 !rle ok
# 5    log2_mscale_dgc 0.6206495 !rle ok; best pam50
# 6    log2_mscale_ggc 0.6218727
